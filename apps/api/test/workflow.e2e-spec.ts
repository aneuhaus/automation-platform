  ...
  beforeAll(async () => {
    ...
    await prisma.user.create({
      data: {
        ...
        passwordHash: '$2b$10$EpI.j.q.Z.F.w.r.t.y.u.i.o.p.a.s.d.f.g.h.j.k.l.z.x.c.v.b.n.m', // Mock hash
        firstName: 'Workflow',
        lastName: 'Tester',
        organizationId: org.id,
      },
    ...
    await prisma.user.deleteMany({ where: { email: 'test-workflow@example.com' } });
